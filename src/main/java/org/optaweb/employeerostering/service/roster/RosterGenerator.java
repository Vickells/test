...
Employee employee = new Employee(tenantId, name,surname,email,phone,currentShift,
contractList.get(generateRandomIntFromThresholds(0.7, 0.5)),
skillProficiencySet);
            
//Employee employee = new Employee(tenantId, employeeView.getName(),employeeView.getSurname()
//,employeeView.getEmail(),employeeView.getPhone(),employeeView.getCurrentShift(),employeeView.getContract(),
