...
public class Employee extends AbstractPersistable {
    ...
    public Employee(Integer tenantId, String name,String surname,String email,Long phone,String currentShift
    ,Contract contract,Set<Skill> skillProficiencySet) {
        super(tenantId);
        this.name = name;
...
public boolean hasSkill(Skill skill) {
    ...
    public boolean equals(Object o) {
        if (o instanceof Employee) {
            ...
            this.currentShift.equals(other.getCurrentShift()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name,surname, contract, email, phone, currentShift, skillProficiencySet);
    }
}
