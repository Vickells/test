...
public class EmployeeServiceTest extends AbstractEntityRequireTenantRestServiceTest {
    ...
    public void getEmployeeTest() throws Exception {
        ...
        EmployeeView employeeView = new EmployeeView(TENANT_ID, "employee", contract,
        testSkillSet, null, null, null, null);
    ...
    public void getNonMatchingEmployeeTest() throws Exception {
        ...
        EmployeeView employeeView = new EmployeeView(TENANT_ID, "employee", contract, 
        testSkillSet, exceptionClass, exceptionClass, null, exceptionClass);
        Employee employee = employeeService.createEmployee(TENANT_ID, employeeView);
    ...
    public void createNonMatchingEmployeeTest() throws Exception {
        ...
        EmployeeView employeeView = new EmployeeView(TENANT_ID, "employee",
        contract, testSkillSet, exceptionClass, exceptionClass, null, exceptionClass);
        String body = (new ObjectMapper()).writeValueAsString(employeeView);
    ...
    public void updateEmployeeTest() throws Exception {
        ...
        EmployeeView updatedEmployee = new EmployeeView(TENANT_ID, "updatedEmployee",
        contract, testSkillSet, null, null, null, null);
    ...
    public void updateChangeTenantIdEmployeeTest() throws Exception {
        ...
        EmployeeView employeeView = new EmployeeView(TENANT_ID, "employee", contractA,
        testSkillSet, exceptionClass, exceptionClass, null, exceptionClass);
        Employee employee = employeeService.createEmployee(TENANT_ID, employeeView);
