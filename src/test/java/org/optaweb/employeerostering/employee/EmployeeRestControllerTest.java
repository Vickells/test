...
public class EmployeeRestControllerTest extends AbstractEntityRequireTenantRestServiceTest {
    ...
    public void employeeCrudTest() {
        ...
        Employee employee = new Employee(TENANT_ID, "employee", contractPathURI, contractPathURI, null, contractPathURI,
        contractA, testSkillSet);
        ...
        Employee updatedEmployee = new Employee(TENANT_ID, "updatedEmployee", contractPathURI, contractPathURI
        , null, contractPathURI, contractA,
                                                testSkillSet);
...
Long email;
String phone;
Contract currentShift;
ResponseEntity<Employee> employeeResponseEntity = addEmployee(TENANT_ID,new Employee());
        //name,surname,email,phone,currentShift
